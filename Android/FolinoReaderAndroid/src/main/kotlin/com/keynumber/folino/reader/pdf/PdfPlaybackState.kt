...
/**
 * Background OMR-playback readiness of an opened PDF. The PDF's own pages are displayed
...
internal sealed interface PdfPlaybackState {
     ...
     * positions back to rectangles on the original PDF pages (the playback cursor, tap-to-seek). */
