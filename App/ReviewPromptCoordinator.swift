...
///
/// Cadence: first prompt on the 10th cold launch, then every 40 cold launches
/// after that (50, 90, 130, …). Apple rate-limits `requestReview` to 3 prompts
/// per 365 days regardless of how often we ask, so spacing them out avoids
