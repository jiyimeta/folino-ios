...
| erasable ink in exported PDFs | `Packages/Features/Reader/Sources/Reader/Annotation/Export/AnnotatedPDFComposer.swift:26` | the AKAnnotationV2 encoder is already shared in |
